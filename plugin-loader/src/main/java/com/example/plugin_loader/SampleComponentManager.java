...
public class SampleComponentManager extends ComponentManager {
     ...
     */
    private static final String DEFAULT_ACTIVITY = "com.example.plugin_runtime.PluginDefaultProxyActivity";
    private static final String SINGLE_INSTANCE_ACTIVITY = "com.example.plugin_runtime.PluginSingleInstance1ProxyActivity";
    private static final String SINGLE_TASK_ACTIVITY = "com.example.plugin_runtime.PluginSingleTask1ProxyActivity";
